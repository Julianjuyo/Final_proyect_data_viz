...
# ---------------------
# VIZ 4: Show per state in the last 10 years which states are the most votes if republican or DEMOCRAT (in a map).
#        All the years show the states that have more republican or democrat Ed in history.
# ---------------------


# ---------------------
# VIZ 5: Show the percentage of votes from each party for the past years.
...
# ---------------------
# VIZ 6: Show the name of the last 10 presidents show their names and show the number of votes they had to win.
# ---------------------
